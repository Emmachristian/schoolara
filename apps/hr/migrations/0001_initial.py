...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateField(
                        db_index=True,
                        help_text="Date when salary is actually paid (or first instalment date)",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        db_index=True,
                        default="MONTHLY",
                        help_text="How often employee is paid (may differ from contract salary_frequency). E.g., monthly contract paid biweekly",
                        max_length=12,
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        default=Decimal("0.00"),
                        help_text="Amount actually owed to employee (gross_pay - total_deductions)",
                        max_digits=15,
                ...
                (
                    ...
                    models.CharField(
                        default="UGX",
                        help_text="ISO 4217 currency code this payroll is denominated in. Defaults to UGX — set from FinancialSettings.school_currency in the view/form that creates the payroll.",
                        max_length=3,
                ...
                (
                    ...
                    models.DecimalField(
                        ...
                        help_text="Rate between payroll currency and school currency at time of payment. Use 1.000000 when currency equals school currency. Stored permanently — never recalculated after payment.",
                        max_digits=12,
                        verbose_name="Exchange Rate",
                    ),
                ),
                (
                    "net_pay_in_school_currency",
                    models.DecimalField(
                        decimal_places=2,
                        default=Decimal("0.00"),
                        help_text="net_pay × exchange_rate. Use this for cross-currency payroll reports and cost dashboards. Equals net_pay when currency = school currency.",
                        max_digits=15,
                        verbose_name="Net Pay in School Currency",
                    ),
                ),
                (
                    "employer_cost_in_school_currency",
                    models.DecimalField(
                        decimal_places=2,
                        default=Decimal("0.00"),
                        help_text="employer_total_cost × exchange_rate. True cost of this employee in school currency.",
                        max_digits=15,
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Bank transfer reference or check number (for single full payments)",
                        max_length=100,
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="User who processed final payment",
                        max_length=50,
                        null=True,
                        verbose_name="Paid By ID",
                    ),
                ),
                (
                    "paid_at",
                ...
                (
                    ...
                    models.BooleanField(
                        db_index=True,
                        default=False,
                        help_text="Payroll was reversed due to error in calculation, wrong employee, or incorrect amounts. Employee was NOT actually paid or payment was recovered.",
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Detailed reason for reversal. Examples: 'Incorrect salary amount calculated', 'Wrong deductions applied', 'Payroll generated for terminated employee', 'Duplicate payroll entry'",
                ...
                (
                    "statutory_reversals_required",
                    models.BooleanField(
                        default=False,
                        help_text="Whether tax/NSSF filings need to be adjusted due to reversal",
                        verbose_name="Statutory Reversals Required",
                    ),
                ),
                (
                    "statutory_adjustments_notes",
                    models.TextField(
                        blank=True,
                        help_text="Details of tax/NSSF adjustments needed for this reversal",
                        verbose_name="Statutory Adjustments Notes",
                    ),
                ),
                (
                ...
                (
                    "payment_method",
                    models.ForeignKey(
                        help_text="Default payment method for this payroll (can be overridden per instalment)",
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="staff_payrolls",
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        ...
                        max_digits=15,
                        null=True,
                        verbose_name="Loan Balance Remaining",
                    ),
                ),
                (
                    "payroll",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["payroll", "allowance_type"],
                name="hr_payrolla_payroll_25ca6e_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="payrollallowance",
            index=models.Index(
                fields=["allowance_type"], name="hr_payrolla_allowan_454061_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="payrollallowance",
            index=models.Index(
                fields=["is_taxable"], name="hr_payrolla_is_taxa_22c9da_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["payroll", "bonus_type"], name="hr_payrollb_payroll_56ccdd_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="payrollbonus",
            index=models.Index(
                fields=["bonus_type"], name="hr_payrollb_bonus_t_c8d681_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="payrollbonus",
            index=models.Index(
                fields=["is_taxable"], name="hr_payrollb_is_taxa_ff7189_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="payrollbonus",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["payroll", "deduction_type"],
                name="hr_payrolld_payroll_1f7384_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="payrolldeduction",
            index=models.Index(
                fields=["deduction_type"], name="hr_payrolld_deducti_921682_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="payrolldeduction",
            index=models.Index(
                fields=["is_pretax"], name="hr_payrolld_is_pret_97cb04_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="payrolldeduction",
            index=models.Index(
                fields=["reference_number"], name="hr_payrolld_referen_e30ec0_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="payrolldeduction",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["payroll", "payment_date"],
                name="hr_payrollp_payroll_79a246_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="payrollpayment",
        ...
        migrations.AddIndex(
            model_name="payrollpayment",
            index=models.Index(
                fields=["payment_method"], name="hr_payrollp_payment_211702_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="payrollpayment",
        ...
        migrations.AddIndex(
            model_name="payroll",
            index=models.Index(
                fields=["staff", "fiscal_period"], name="hr_payroll_staff_i_9035b7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="payroll",
            index=models.Index(
                ...
                name="hr_payroll_staff_i_46eec9_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="payroll",
            index=models.Index(
                fields=["fiscal_period", "status"], name="hr_payroll_fiscal__6955c9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="payroll",
        ...
        migrations.AddIndex(
            model_name="payroll",
            index=models.Index(
                fields=["reversed"], name="hr_payroll_reverse_d495a4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="payroll",
            index=models.Index(
                fields=["reversed_on"], name="hr_payroll_reverse_507b1d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="payroll",
            index=models.Index(
                fields=["statutory_reversals_required"],
                name="hr_payroll_statuto_6018ae_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="payroll",
            index=models.Index(
                fields=["pay_frequency"], name="hr_payroll_pay_fre_f357fe_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="payroll",
            index=models.Index(
                fields=["pay_period_label"], name="hr_payroll_pay_per_18a0b3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="payroll",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    ("pay_period_start__lt", models.F("pay_period_end"))
                ),
        ...
        migrations.AddConstraint(
            model_name="payroll",
            constraint=models.CheckConstraint(
                condition=models.Q(("gross_pay__gte", 0)),
        ...
        migrations.AddConstraint(
            model_name="payroll",
            constraint=models.CheckConstraint(
                condition=models.Q(("net_pay__gte", 0)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                ...
                name="payroll_exchange_rate_positive",
            ),
        ),
        migrations.AddIndex(
            model_name="contract",
