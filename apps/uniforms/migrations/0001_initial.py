...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Currency this sale is denominated in. Example: 'UGX' for a South Sudan school whose director prices uniforms in Ugandan shillings. Blank = school's primary currency.",
                        max_length=3,
                ...
                (
                    ...
                    models.DecimalField(
                        ...
                        help_text="Rate between sale currency and school currency at time of sale. Stored permanently — never recalculated after the fact.",
                        max_digits=12,
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=50,
                        null=True,
                        verbose_name="Returned By ID",
                    ),
                ),
                (
                    "return_reason",
                    models.TextField(blank=True, verbose_name="Return Reason"),
                ),
                (
                    "return_condition",
                    models.CharField(
                ...
                (
                    "partial_return",
                    models.BooleanField(default=False, verbose_name="Partial Return"),
                ),
                ("notes", models.TextField(blank=True, verbose_name="Notes")),
                (
                    "internal_notes",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Currency this line item is priced in. Leave blank to inherit from UniformPurchaseOrder.",
                        max_length=3,
        ...
        migrations.AddIndex(
            model_name="uniformsale",
            index=models.Index(
                fields=["cancelled"], name="uniforms_un_cancell_37473b_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="uniformsale",
            index=models.Index(
                fields=["returned"], name="uniforms_un_returne_34a799_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="uniformsale",
