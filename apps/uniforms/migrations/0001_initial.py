...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        db_index=True,
                        default=False,
                        help_text="Sale was cancelled before items were issued to student. No inventory adjustment needed (items never left warehouse).",
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Detailed reason for cancellation. Examples: 'Student withdrew before receiving items', 'Wrong items selected', 'Parent changed mind before payment/issuance'",
                ...
                (
                    ...
                    models.BooleanField(
                        db_index=True,
                        default=False,
                        help_text="Issued items were physically returned by student. Items are added back to inventory.",
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Why items were returned. Examples: 'Wrong size issued', 'Student withdrew from school', 'Items defective', 'Parent requested refund'",
        ...
        migrations.AddIndex(
            model_name="uniformsale",
            index=models.Index(
                fields=["cancelled_on"], name="uniforms_un_cancell_f4dd21_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="uniformsale",
            index=models.Index(
                fields=["returned_on"], name="uniforms_un_returne_2eb073_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="uniformsale",
