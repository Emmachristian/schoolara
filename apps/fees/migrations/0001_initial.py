...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        verbose_name="Use Allowance Method",
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        verbose_name="Use Variable Amount",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.DecimalField(
                        ...
                        verbose_name="Maximum Discount Percentage",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        ...
                        verbose_name="Scholarship Priority",
                    ),
                ),
                (
                    "is_mandatory",
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        verbose_name="Override Billing Periods",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        ...
                        verbose_name="Payable in Installments",
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        db_index=True,
                        default=False,
                        help_text="Payment was reversed due to internal error (wrong invoice, duplicate entry). No actual money was returned - this is an accounting correction only.",
                ...
                (
                    ...
                    models.BooleanField(
                        db_index=True,
                        default=False,
                        help_text="Actual money was returned to the payer (overpayment, cancellation, withdrawal). This represents real cash outflow from school accounts.",
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        verbose_name="Requires Budget Tracking",
                    ),
                ),
                (
                    "maximum_recipients",
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        default=Decimal("0.00"),
                        help_text="For budget-based scholarships: Total amount available across all sessions. For policy-based scholarships: Set to 0.00 (discount comes from program percentage).",
                        max_digits=12,
                        validators=[
                            django.core.validators.MinValueValidator(Decimal("0.00"))
                        ],
                ...
                (
                    ...
                    models.CharField(
                        ...
                        help_text="How to distribute the scholarship. For policy-based (percentage) scholarships, use PROPORTIONAL. For budget-based scholarships, choose based on how to allocate the fixed amount.",
                        max_length=20,
        ...
        migrations.AddIndex(
            model_name="payment",
            index=models.Index(
                fields=["reversed_on"], name="fees_paymen_reverse_38baa1_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="payment",
