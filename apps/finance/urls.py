...
- Added expense_cancel action URL (was missing — cancel modal posted to nothing)
- Added expense_reject action URL (was missing — reject modal posted to nothing)
- Added expense_payment_reversal_print URL (was missing entirely)
- Fixed expense_line_edit_modal: <uuid:pk> → <uuid:line_pk>
- Fixed budget_line_edit_modal: <uuid:pk> → <uuid:line_pk>
- Fixed journal_transaction_edit_modal: <uuid:pk> → <uuid:transaction_pk>
- Fixed approval_history_modal: <str:content_type>/<uuid:object_id> → <str:model_name>/<uuid:pk>
- Fixed export_options_modal: <str:resource_type> → <str:model_name>
"""
...
urlpatterns = [
    ...
    # FIX: these two were missing — cancel_expense.html and reject_expense.html post to them
    path('expenses/<uuid:pk>/cancel/', views.expense_cancel, name='expense_cancel'),
    path('expenses/<uuid:pk>/reject/', views.expense_reject, name='expense_reject'),

    # Print & Export
    path('expenses/<uuid:pk>/print/', views.expense_print_view,    name='expense_print_view'),
    path('expenses/print/',           views.expense_list_print_view, name='expense_list_print'),
    ...
    # Expense Lines
    path('expenses/<uuid:expense_pk>/lines/add/modal/',
         modal_views.expense_line_form_modal, name='expense_line_add_modal'),
    path('expenses/<uuid:expense_pk>/lines/<uuid:line_pk>/edit/modal/',
         modal_views.expense_line_form_modal, name='expense_line_edit_modal'),
    path('expense-lines/<uuid:pk>/modal/delete/',
         modal_views.expense_line_delete_modal, name='expense_line_delete_modal'),
    ...
    # EXPENSE PAYMENTS
    # =========================================================================
    # NOTE: No standalone list, create, detail or edit pages.
    # All payments are recorded and viewed via modals from the expense detail page.

    # Action endpoints (POST targets from modals)
    ...
    # Print / document views (kept — opened in new tab from modal)
    path('expense-payments/<uuid:pk>/print/receipt/',
         views.expense_payment_print_receipt, name='expense_payment_print_receipt'),
    path('expense-payments/<uuid:pk>/reversals/',
         views.expense_payment_reversal_detail, name='expense_payment_reversal_detail'),
    path('expense-payments/<uuid:pk>/reversals/print/',
         views.expense_payment_reversal_print, name='expense_payment_reversal_print'),

    # Modal Views
    path('expenses/<uuid:expense_pk>/payments/add/modal/',
         modal_views.expense_payment_form_modal, name='expense_payment_add_modal_for_expense'),
    path('expense-payments/<uuid:payment_pk>/edit/modal/',
         modal_views.expense_payment_form_modal, name='expense_payment_edit_modal'),
    path('expense-payments/<uuid:pk>/modal/delete/',
         modal_views.expense_payment_delete_modal, name='expense_payment_delete_modal'),
    path('expense-payments/<uuid:pk>/modal/verify/',
         modal_views.expense_payment_verify_modal, name='expense_payment_verify_modal'),
    path('expense-payments/<uuid:pk>/modal/reverse/',
         modal_views.expense_payment_reverse_modal, name='expense_payment_reverse_modal'),
    path('expense-payments/<uuid:pk>/modal/detail/',
         modal_views.expense_payment_detail_modal, name='expense_payment_detail_modal'),
    path('expense-payments/<uuid:pk>/modal/quick-view/',
         modal_views.expense_payment_detail_modal, name='expense_payment_quick_view_modal'),
    path('expense-payments/bulk/verify/modal/',
         modal_views.bulk_payment_verification_modal, name='bulk_payment_verification_modal'),
    ...
    path('journal-entries/<uuid:entry_pk>/transactions/<uuid:transaction_pk>/edit/modal/', modal_views.journal_transaction_form_modal, name='journal_transaction_edit_modal'),
    ...
    path('budgets/<uuid:budget_pk>/lines/add/modal/',
         modal_views.budget_line_form_modal, name='budget_line_add_modal'),
    path('budgets/<uuid:budget_pk>/lines/<uuid:line_pk>/edit/modal/',
         modal_views.budget_line_form_modal, name='budget_line_edit_modal'),
    path('budget-lines/<uuid:pk>/modal/delete/',
         modal_views.budget_line_delete_modal, name='budget_line_delete_modal'),
    ...
    path('export/<str:model_name>/options/modal/', modal_views.export_options_modal, name='export_options_modal'),
    ...
    # UTILITY ENDPOINTS
    # =========================================================================
    path('approval-history/<str:model_name>/<uuid:pk>/modal/', modal_views.approval_history_modal, name='approval_history_modal'),
