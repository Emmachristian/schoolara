...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        verbose_name="Affects Balance Sheet",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        ...
                        verbose_name="Affects Income Statement",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Currency this payment was made in. Blank = school's primary currency. Example: 'UGX' for a South Sudan school paying a Ugandan supplier.",
                        max_length=3,
                ...
                (
                    ...
                    models.DecimalField(
                        ...
                        help_text="Rate between payment currency and school currency at time of payment. Stored permanently — never recalculated after saving.",
                        max_digits=12,
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        default=Decimal("0.00"),
                        help_text="amount × exchange_rate. This is what posts to the journal and ledger. Use this field for all aggregations across payments.",
                        max_digits=15,
                ...
                (
                    "check_number",
                    models.CharField(
                        blank=True, max_length=20, verbose_name="Check/Cheque Number"
                    ),
                ),
                (
                    "payment_details",
                ...
                (
                    "performed_by",
                    models.CharField(
                        default="System", max_length=100, verbose_name="Performed By"
                    ),
                ),
                (
                ...
                (
                    ...
                    models.BooleanField(
                        db_index=True,
                        default=False,
                        help_text="Payment was reversed due to internal error — wrong vendor, duplicate entry, wrong amount. Accounting correction only, no actual money movement.",
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Detailed reason: 'Duplicate payment entry', 'Posted to wrong expense', 'Incorrect vendor', 'Wrong amount entered'",
                        verbose_name="Reversal Reason",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=True, verbose_name="Reversal Approval Required"
                    ),
                ),
                (
                ...
                (
                    "reversal_approved_on",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Reversal Approved On"
                    ),
                ),
                (
                    "auto_create_journal_entry",
        ...
        migrations.AddIndex(
            model_name="account",
            index=models.Index(
                fields=["is_header"], name="finance_acc_is_head_dd455c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="account",
        ...
        migrations.AddIndex(
            model_name="expensepayment",
            index=models.Index(
                fields=["reversed"], name="finance_exp_reverse_10bf43_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="expensepayment",
            index=models.Index(
                fields=["reversed_on"], name="finance_exp_reverse_94dc72_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="expensepayment",
            index=models.Index(
                fields=["reversal_approved_by_id"],
                name="finance_exp_reversa_320112_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="expensepayment",
            index=models.Index(
                fields=["currency"], name="finance_exp_currenc_e3add5_idx"
            ),
        ),
        ...
        migrations.AddConstraint(
            model_name="expensepayment",
            constraint=models.CheckConstraint(
                condition=models.Q(("bank_charges__gte", 0)),
