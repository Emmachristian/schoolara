# Generated by Django 5.2 on 2026-01-09 13:24
...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        help_text="Determines the complexity of the chart of accounts. Leave blank to auto-determine based on school type and size. BASIC: 10-12 accounts (small schools). STANDARD: 20-30 accounts (medium schools). ADVANCED: 50-60 accounts (large schools with auditors).",
                        max_length=20,
                        null=True,
                        verbose_name="Accounting Complexity",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        ...
                        verbose_name="Financial Setup Complete",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        ...
                        verbose_name="Academic Setup Complete",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        ...
                        verbose_name="Initial Setup Complete",
                    ),
                ),
                (
                    "setup_completed_at",
        ...
        migrations.AddIndex(
            model_name="school",
            index=models.Index(fields=["domain"], name="schools_domain_dd6e46_idx"),
        ),
        migrations.AddIndex(
            model_name="school",
            index=models.Index(
        ...
        migrations.AddIndex(
            model_name="school",
            index=models.Index(
                fields=["is_active_subscription"], name="schools_is_acti_03c586_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="school",
            index=models.Index(
                fields=["is_initial_setup_complete"], name="schools_is_init_81e630_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="school",
            index=models.Index(
                fields=["accounting_complexity"], name="schools_account_7805bc_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="school",
