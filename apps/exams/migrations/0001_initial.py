    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        ...
                        verbose_name="Applicable Subject Types",
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        default="ALL",
                        max_length=20,
                        verbose_name="Curriculum Compatibility",
                    ),
                ),
                (
                    "frequency",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        ...
                        verbose_name="Required Payment Percentage",
                    ),
                ),
                (
                    "consider_all_outstanding_balances",
                    models.BooleanField(
                        default=False,
                        help_text="If True, all outstanding balances are considered. If False, only current term balance.",
                        verbose_name="Consider All Outstanding Balances",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        ...
                        verbose_name="Registration Deadline (Days Before Exam)",
                    ),
                ),
                (
                    "allows_retakes",
                    models.BooleanField(default=True, verbose_name="Allows Retakes"),
                ),
                (
                    "max_retakes",
                    models.PositiveIntegerField(
                        ...
                        verbose_name="Maximum Retakes",
                    ),
                ),
                (
                    "includes_in_report_cards",
                    models.BooleanField(
                        default=True, verbose_name="Include in Report Cards"
                    ),
                ),
                (
                    "public_results",
                    models.BooleanField(default=False, verbose_name="Public Results"),
                ),
                (
                    "results_publication_days",
                    models.PositiveIntegerField(
                        default=14,
                        help_text="Days after exam completion when results are published",
                        verbose_name="Results Publication (Days After Exam)",
                    ),
                ),
                (
                    "is_active",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=200, verbose_name="Examination Name"),
                ),
                (
                    "code",
                    models.CharField(
                        max_length=50, unique=True, verbose_name="Examination Code"
                    ),
                ),
                (
                    "description",
                ...
                (
                    ...
                    models.DecimalField(
                        ...
                        max_digits=4,
                        verbose_name="Subject Type Weight",
                    ),
                ),
                ...
                (
                    "instructions",
                    models.TextField(
                        blank=True, verbose_name="Examination Instructions"
                    ),
                ),
                (
                    "materials_allowed",
                    models.TextField(blank=True, verbose_name="Materials Allowed"),
                ),
                (
                ...
                (
                    "examination_venue",
                    models.CharField(
                        blank=True, max_length=200, verbose_name="Examination Venue"
                    ),
                ),
                (
                    "auto_submit",
                    models.BooleanField(default=False, verbose_name="Auto Submit"),
                ),
                (
                ...
                (
                    "allow_review",
                    models.BooleanField(default=True, verbose_name="Allow Review"),
                ),
                (
                    "status",
                    models.CharField(
                        ...
                        default="PLANNED",
                        max_length=15,
                        verbose_name="Examination Status",
                    ),
                ),
                (
                    "results_published",
                    models.BooleanField(
                        default=False, verbose_name="Results Published"
                    ),
                ),
                (
                    "results_publication_date",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Results Publication Date"
                    ),
                ),
                (
                    "notes",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "students_failed",
                    models.PositiveIntegerField(
                        default=0, verbose_name="Students Failed"
                    ),
                ),
                (
                    "highest_score",
                ...
                (
                    "subject_type_performance",
                    models.JSONField(
                        blank=True,
                        default=dict,
                        help_text="Performance metrics specific to subject type",
                        verbose_name="Subject Type Performance",
                    ),
                ),
                (
                    ...
                    models.JSONField(
                        ...
                        verbose_name="Curriculum Performance",
                    ),
                ),
                (
                    "class_performance",
                    models.JSONField(
                        ...
                        verbose_name="Class Performance",
                    ),
                ),
                (
                    "average_time_taken",
                    models.DecimalField(
                        ...
                        max_digits=6,
                        null=True,
                        verbose_name="Average Time Taken (Minutes)",
                    ),
                ),
                (
                    "last_calculated",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Payment Verification Date"
                    ),
                ),
                (
                ...
                (
                    "requires_assistance",
                    models.BooleanField(
                        default=False, verbose_name="Requires Assistance"
                    ),
                ),
                (
                    "notes",
                    models.TextField(blank=True, verbose_name="Registration Notes"),
                ),
                (
                    "is_active",
                    models.BooleanField(default=True, verbose_name="Is Active"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=100, unique=True, verbose_name="Grading System Name"
                    ),
                ),
                (
                    "code",
                    models.CharField(
                        max_length=20, unique=True, verbose_name="System Code"
                    ),
                ),
                (
                    "description",
                ...
                (
                    "uses_letter_grades",
                    models.BooleanField(
                        default=True, verbose_name="Uses Letter Grades"
                    ),
                ),
                (
                    "uses_numerical_scores",
                    models.BooleanField(
                        default=True, verbose_name="Uses Numerical Scores"
                    ),
                ),
                (
                    "uses_aggregates",
                    models.BooleanField(default=False, verbose_name="Uses Aggregates"),
                ),
                (
                    "uses_color_codes",
                    models.BooleanField(default=True, verbose_name="Uses Color Codes"),
                ),
                (
                    "uses_gpa",
                    models.BooleanField(
                        default=False, verbose_name="Uses GPA Calculation"
                    ),
                ),
                (
                    ...
                    models.PositiveIntegerField(
                        ...
                        verbose_name="Minimum Subjects Required",
                    ),
                ),
                (
                    "maximum_subjects_considered",
                    models.PositiveIntegerField(
                        blank=True,
                        help_text="Maximum number of subjects to consider in calculations (leave blank for no limit)",
                        null=True,
                        verbose_name="Maximum Subjects Considered",
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        default="ALL",
                        max_length=20,
                        verbose_name="Subject Selection Method",
                    ),
                ),
                (
                    "uses_subject_weighting",
                    models.BooleanField(
                        default=False,
                        help_text="Whether different subjects have different weights",
                        verbose_name="Uses Subject Weighting",
                    ),
                ),
                (
                    "aggregate_calculation_method",
                    models.CharField(
                        choices=[
                            ("SUM", "Sum of Grades"),
                        ...
                        default="AVERAGE",
                        max_length=20,
                        verbose_name="Aggregate Calculation Method",
                    ),
                ),
                (
                    ...
                    models.PositiveIntegerField(
                        ...
                        null=True,
                        verbose_name="Maximum Failures Allowed",
                    ),
                ),
                (
                    "requires_mathematics",
                    models.BooleanField(
                        default=False, verbose_name="Requires Mathematics"
                    ),
                ),
                (
                    "requires_english",
                    models.BooleanField(default=False, verbose_name="Requires English"),
                ),
                (
                    "requires_science",
                    models.BooleanField(
                        default=False, verbose_name="Requires at least one Science"
                    ),
                ),
                (
                    "include_positions",
                    models.BooleanField(
                        default=True, verbose_name="Include Class Positions"
                    ),
                ),
                (
                    "calculate_average",
                    models.BooleanField(
                        default=True, verbose_name="Calculate Class Average"
                    ),
                ),
                (
                    "calculate_totals",
                    models.BooleanField(
                        default=True, verbose_name="Calculate Subject Totals"
                    ),
                ),
                (
                    "round_to_nearest",
                ...
                (
                    "is_default",
                    models.BooleanField(
                        default=False, verbose_name="Is Default System"
                    ),
                ),
                (
                    "effective_date",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "grade_name",
                    models.CharField(
                        blank=True, max_length=50, verbose_name="Grade Name"
                    ),
                ),
                (
                    "min_score",
                    models.DecimalField(
                        decimal_places=2, max_digits=6, verbose_name="Minimum Score"
                    ),
                ),
                (
                    "max_score",
                    models.DecimalField(
                        decimal_places=2, max_digits=6, verbose_name="Maximum Score"
                    ),
                ),
                (
                    "aggregate",
                ...
                (
                    "comments",
                    models.TextField(blank=True, verbose_name="Grade Comments"),
                ),
                (
                    "description",
                    models.TextField(blank=True, verbose_name="Grade Description"),
                ),
                (
                    "performance_level",
                    models.CharField(
                ...
                (
                    "is_passing_grade",
                    models.BooleanField(default=True, verbose_name="Is Passing Grade"),
                ),
                (
                    "display_order",
                    models.PositiveIntegerField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False, verbose_name="Is Default for Class"
                    ),
                ),
                (
                    "assignment_reason",
                    models.TextField(blank=True, verbose_name="Assignment Reason"),
                ),
                (
                    "custom_pass_mark",
                    models.DecimalField(
                        ...
                        max_digits=6,
                        null=True,
                        verbose_name="Custom Pass Mark",
                    ),
                ),
                (
                    "custom_maximum_score",
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                        ...
                        max_digits=6,
                        null=True,
                        verbose_name="Custom Maximum Score",
                    ),
                ),
                (
                    "curriculum_override",
                    models.CharField(
                        ...
                        max_length=20,
                        verbose_name="Curriculum Override",
                    ),
                ),
                (
                    ...
                    models.JSONField(
                        ...
                        verbose_name="Subject Type Overrides",
                    ),
                ),
                (
                    "include_in_report_cards",
                    models.BooleanField(
                        default=True, verbose_name="Include in Report Cards"
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=True, verbose_name="Show Grade Breakdown"
                    ),
                ),
                (
                    "academic_session",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "grade",
                    models.CharField(blank=True, max_length=10, verbose_name="Grade"),
                ),
                (
                    "grade_points",
                    models.DecimalField(
                ...
                (
                    "submission_time",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Submission Time"
                    ),
                ),
                ...
                (
                    "rank_in_subject",
                    models.PositiveIntegerField(
                        blank=True, null=True, verbose_name="Rank in Subject"
                    ),
                ),
                (
                    "attempt_number",
                ...
                (
                    "correct_answers",
                    models.PositiveIntegerField(
                        blank=True, null=True, verbose_name="Correct Answers"
                    ),
                ),
                (
                    "incorrect_answers",
                    models.PositiveIntegerField(
                        blank=True, null=True, verbose_name="Incorrect Answers"
                    ),
                ),
                (
                    "unanswered",
                    models.PositiveIntegerField(
                        blank=True, null=True, verbose_name="Unanswered"
                    ),
                ),
                (
                    "teacher_comments",
                ...
                (
                    "examiner_comments",
                    models.TextField(blank=True, verbose_name="Examiner Comments"),
                ),
                (
                    "is_verified",
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        verbose_name="Grade Locked",
                    ),
                ),
                (
                    "grade_locked_at",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Grade Locked At"
                    ),
                ),
                (
                    "locked_grade_data",
                    models.JSONField(
                        ...
                        verbose_name="Locked Grade Data",
                    ),
                ),
                (
                    "auto_lock_after_publication",
                    models.BooleanField(
                        default=True,
                        help_text="Automatically lock grades when results are published",
                        verbose_name="Auto-lock After Publication",
                    ),
                ),
                (
                    "lock_reason",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["category_type"], name="exams_examc_categor_d735d1_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="examcategory",
            index=models.Index(
                fields=["is_active"], name="exams_examc_is_acti_cc17b7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="examcategory",
            index=models.Index(
                fields=["frequency"], name="exams_examc_frequen_0c5d65_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="examcategory",
            index=models.Index(
                fields=["curriculum_compatibility"],
                name="exams_examc_curricu_e2833d_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="examregistration",
            index=models.Index(
                fields=["student", "status"], name="exams_examr_student_0188d9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="examregistration",
            index=models.Index(
                fields=["examination", "status"], name="exams_examr_examina_c7be82_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["grading_type"], name="exams_gradi_grading_4f286a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="gradingsystem",
            index=models.Index(
                fields=["is_active"], name="exams_gradi_is_acti_a670e7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="gradingsystem",
            index=models.Index(
                fields=["is_default"], name="exams_gradi_is_defa_fbfb07_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="gradingsystem",
            index=models.Index(
                fields=["curriculum_compatibility"],
                name="exams_gradi_curricu_b05392_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="gradingsystem",
            index=models.Index(
                fields=["subject_type_specific"], name="exams_gradi_subject_5249c6_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="gradingrange",
            index=models.Index(
                fields=["grading_system", "min_score", "max_score"],
                name="exams_gradi_grading_7f440a_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="gradingrange",
            index=models.Index(
                fields=["is_passing_grade"], name="exams_gradi_is_pass_3a617c_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="gradingrange",
        ...
        migrations.AddIndex(
            model_name="examination",
            index=models.Index(
                fields=["exam_category", "academic_session"],
                name="exams_exami_exam_ca_8a653d_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="examination",
            index=models.Index(
                fields=["subject", "exam_date"], name="exams_exami_subject_533729_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="examination",
        ...
        migrations.AddIndex(
            model_name="examination",
            index=models.Index(
                fields=["exam_date", "start_time"],
                name="exams_exami_exam_da_e7420b_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="examination",
            index=models.Index(
                fields=["curriculum_type"], name="exams_exami_curricu_ccaca4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="classgradingsystem",
            index=models.Index(
                fields=["class_instance", "academic_session", "is_active"],
                name="exams_class_class_i_7b6776_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="classgradingsystem",
            index=models.Index(
                fields=["grading_system", "is_active"],
                name="exams_class_grading_11897e_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="classgradingsystem",
            index=models.Index(
                ...
                name="exams_class_effecti_824eef_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="classgradingsystem",
            index=models.Index(
                fields=["priority"], name="exams_class_priorit_872de2_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="classgradingsystem",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["student", "examination"], name="exams_stude_student_622aba_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="studentexamresult",
            index=models.Index(
                fields=["examination", "score"], name="exams_stude_examina_08bf27_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="studentexamresult",
        ...
        migrations.AddIndex(
            model_name="studentexamresult",
            index=models.Index(
                fields=["is_published"], name="exams_stude_is_publ_a1cfc3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="studentexamresult",
            index=models.Index(
                fields=["rank_in_class"], name="exams_stude_rank_in_86bc0f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="studentexamresult",
            index=models.Index(
                fields=["is_grade_locked"], name="exams_stude_is_grad_96e097_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="studentexamresult",
            index=models.Index(
                fields=["grade_locked_at"], name="exams_stude_grade_l_45aa85_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="studentexamresult",
