        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        default="MANUAL",
                        help_text="Where this rate came from: MANUAL / ExchangeRate-API / Fixer.io / OpenExchangeRates / <source> (inverse) for auto-computed inverse rates.",
                        max_length=50,
                        verbose_name="Source",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Automatically fetch exchange rates from external APIs. When disabled, cashiers enter rates manually at payment time.",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=6,
                        help_text="How often to fetch updated rates (1–168 hours). Only used when auto_update_exchange_rates is True.",
                        validators=[
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=list,
                        help_text='ISO 4217 codes of foreign currencies to track rates for. Example: ["USD", "EUR", "GBP"]. School currency is always excluded — no rate needed for same currency.',
