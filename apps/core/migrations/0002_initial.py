    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="core_exchan_from_cu_c0e77e_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="exchangerate",
            index=models.Index(
                fields=["date", "is_active"], name="core_exchan_date_34387d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="exchangerate",
            index=models.Index(fields=["source"], name="core_exchan_source_83e428_idx"),
        ),
